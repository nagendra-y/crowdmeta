...
cmGlobal.controller('cmController', ['$scope', '$window', '$compile', '$timeout', '$anchorScroll', 
		function($scope, $window, $compile, $timeout, $anchorScroll) {
				...
				$scope.campaign = {
						"title": "Hampi - A Golden Era",
						"description": "A one of a kind photography project to capture the Golden ages of Hampi into a coffee-table book, by eminent photographer Vishwanath Suvarna. Dedicated to history lovers and photo enthusiasts alike, you are in for a visual treat!",
						"raised": 0, 
						"target": 3000000, 
						"days": 42,
						"image": 'images/main-0.jpg',
						"thumbnails" : ['images/main-0.jpg','images/main-1.jpg', 'images/main-2.jpg', 'images/main-3.jpg'],
						"supporters" : [],
						"rewards": []
				};
